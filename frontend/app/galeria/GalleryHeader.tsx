                ...
                <div className="flex items-center gap-3">
                    {isAdmin ? (
                        <>
                            <Link
                                href="/new"
                                className="px-6 py-2.5 bg-zinc-900 text-white rounded-lg text-sm font-semibold hover:bg-zinc-800 transition-colors shadow-sm"
                            >
                                Novo Projeto
                            </Link>
                            <button
                        ...
                        <button
                            ...
                            className="px-6 py-2.5 bg-white border border-zinc-200 text-zinc-700 rounded-lg text-sm font-semibold hover:bg-zinc-50 transition-colors shadow-sm flex items-center gap-2"
                        >
